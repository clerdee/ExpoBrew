    ...
    <View style={styles.bg}>
      <View style={styles.top}>
        <View style={styles.head}>
          <View style={styles.hRow}><IconButton icon="menu" size={28} iconColor="#FFF" onPress={() => navigation.openDrawer()} style={{ marginLeft: -10 }} /><Text style={styles.title}>Promotions</Text><IconButton icon="plus-box" size={28} iconColor="#FFF" onPress={() => setModal(true)} style={{ marginRight: -10 }} /></View>
        </View>
