    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : "height"}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.content}>
          ...
          {/* Register Button */}
          <Button mode="contained" buttonColor="#6F4E37" contentStyle={styles.registerBtnContent} labelStyle={styles.registerBtnLabel} style={styles.registerBtn} onPress={handleRegister} loading={isLoading} disabled={isLoading}>
          ...
          <View style={styles.socialContainer}>
            <TouchableOpacity style={styles.socialBtn} onPress={() => console.log('Google Auth')} activeOpacity={0.8}>
              <MaterialCommunityIcons name="google" size={24} color="#DB4437" />
              <Text style={styles.socialText}>Google</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.socialBtn} onPress={() => console.log('Facebook Auth')} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  socialBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: '#EBE1D7', marginHorizontal: 5 },
