...
const styles = StyleSheet.create({
  ...
  img: { width: 70, height: 70, borderRadius: 12 }, info: { flex: 1, marginLeft: 15 }, name: { fontWeight: 'bold', color: '#333' }, note: { color: '#888', fontSize: 11, lineHeight: 14, marginVertical: 4 }, price: { fontWeight: 'bold', color: '#6F4E37' },
